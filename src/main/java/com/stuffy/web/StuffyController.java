...
public class StuffyController {
	...
	//demo of Request Parameters -- post request
	//http://localhost:8080/stuffies?id=10&type=Fish&color=orange&size=small&limbs=3
//	@GetMapping("")
//	public Stuffy createAStuffy(@RequestParam int id, @RequestParam String type, @RequestParam String color, 
//			@RequestParam String size, @RequestParam int limbs) {
